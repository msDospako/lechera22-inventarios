...
import reportesDataMock from "../../data/reportesDataMock.js"; // ✅ Nuevo mock mensual
        ...
        <div className="flex min-h-screen bg-gray-950 text-white">
            ...
            <div className="flex-1 p-6 ml-[240px] transition-all duration-300">
                ...
                <header className="reportes-header mb-6">
                    <h1 className="reportes-title">Panel de Reportes — {data.mes}</h1>
                    <p className="reportes-subtitle">
                        Visualización y análisis de desempeño general de la planta e inventarios.
                    </p>
                    <span className="reportes-fecha">Actualizado: 22 Oct 2025</span>
                </header>
